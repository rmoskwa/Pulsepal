...
IMPORTANT: All code blocks must be tagged with their source at the beginning:
- **For code you create**: Add `---Generated by Gemini---` as the first line
- **For retrieved examples**: Add `---Retrieved example---` as the first line
...
Example for retrieved code:
```matlab
---Retrieved example---
% Code from search results
