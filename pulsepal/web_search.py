...
class WebSearchService:
    ...
    def search_mri_information(
        self, query: str, max_results: int = 5, focus_areas: Optional[List[str]] = None
    ) -> str:
        """
    ...
    def _mock_pulseq_resources(
        self, query: str, resource_type: Optional[str]
    ) -> List[Dict[str, Any]]:
    ...
    def _format_pulseq_results(self, results: List[Dict[str, Any]], query: str) -> str:
