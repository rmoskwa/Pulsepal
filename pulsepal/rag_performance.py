...
class RAGPerformanceMonitor:
    ...
    def __init__(self, max_history: int = 1000):
        ...
        logger.info(f"RAG Performance Monitor initialized with history size: {max_history}")
    ...
    def get_performance_stats(self, window_minutes: Optional[int] = None) -> PerformanceStats:
        """
        ...
        with self._lock:
            ...
            similarities = [q.avg_similarity for q in recent_queries if q.avg_similarity > 0]
    ...
    def get_percentiles(self, metric: str = "duration") -> Dict[str, float]:
        ...
        with self._lock:
            ...
            return {
                ...
                "p90": statistics.quantiles(values, n=10)[8] if len(values) >= 10 else values[-1],
    ...
    def get_slow_queries(self, threshold_seconds: float = 1.0, limit: int = 10) -> List[QueryMetrics]:
        """
    ...
    def get_query_pattern_analysis(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "repeat_query_rate": 1 - (len(self.query_stats) / len(self.query_history))
            }
    ...
    def export_metrics(self, format: str = "dict") -> Any:
        ...
        with self._lock:
            if format == "dict":
                ...
                # Write headers
                writer.writerow([
                    "timestamp", "query", "duration", "result_count", 
                    "avg_similarity", "search_type", "rerank_enabled", 
                    "hybrid_search", "error"
                ])
                ...
                for q in self.query_history:
                    writer.writerow([
                        q.timestamp, q.query[:100], q.duration, q.result_count,
                        q.avg_similarity, q.search_type, q.rerank_enabled,
                        q.hybrid_search, q.error or ""
                    ])
